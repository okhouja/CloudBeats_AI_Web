...
/**
 * Full "Behind the Beats" narrative for v2 About page.
 * Same content as /about, styled for v2; back link stays within v2 when backHref="/v2".
 */
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="mt-8 max-w-2xl space-y-5 leading-relaxed">
            ...
            <p className="text-[var(--cb-text)]/90">
              ...
              stretching textures beyond their natural limits. I had no formal
              training. No synthesizers. No roadmap.
            </p>
            ...
            <p className="text-[var(--cb-text-muted)]">
              ...
              and knowledge that felt out of reach. So I worked with what I had:
              curiosity, repetition, and a pair of ears that were always
              searching.
            </p>
            <p className="text-[var(--cb-text-muted)]">
            ...
            <p className="text-[var(--cb-text-muted)]">
              Years later, a personal hearing challenge reshaped my relationship
              with sound. Silence was no longer neutral. Awareness became
              sharper. Listening became intentional.
            </p>
            <p className="text-[var(--cb-text-muted)]">
            ...
            <p className="text-[var(--cb-text-muted)]">
              I began learning Ableton Live — not casually, but structurally. And
              I discovered something humbling: learning music production is not
              easier than learning programming. Both demand discipline. Both
              require iteration. Both expose your limitations before they reward
              your persistence.
            </p>
